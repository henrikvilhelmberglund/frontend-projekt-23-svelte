...
let b = "";
let l = "";
string.forEach((thingy) => {
	if (thingy !== "") {
		if (`"${thingy.split("\t")[0]}"`.includes(".")) {
		} else {
			if (!thingy.includes("-m-")) {
				output += `"${thingy.split("\t")[0]}",\n`;
			} else if (thingy.includes("-px-")) {
				x += `"${thingy.split("\t")[0]}",\n`;
			} else if (thingy.includes("-py")) {
				y += `"${thingy.split("\t")[0]}",\n`;
			} else if (thingy.includes("-pt")) {
				t += `"${thingy.split("\t")[0]}",\n`;
			} else if (thingy.includes("-pr")) {
				r += `"${thingy.split("\t")[0]}",\n`;
			} else if (thingy.includes("-pb")) {
				b += `"${thingy.split("\t")[0]}",\n`;
			} else if (thingy.includes("-pl")) {
				l += `"${thingy.split("\t")[0]}",\n`;
			}
		}
		// output += `"${thingy.split("\t")[0]}",\n`;
